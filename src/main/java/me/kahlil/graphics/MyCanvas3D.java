 ...
 *
 * <p>When the system calls the paintComponent method to repaint the jPanel the backbuffer Image is
...
public class MyCanvas3D extends JPanel implements Canvas3D {
  ...
  public void paintComponent(Graphics g) {
    ...
    if (buffer == null) buffer = this.createImage(bufferwidth, bufferheight);
