...
public class LinearTransformation implements UnaryOperator<Vector> {
  ...
  /**
   * Returns a transform that will translates a vector x units in the x-direction, y units in the
  ...
  /**
   * Returns a transform that scales a vector (v1, v2, v3) to (v1 * xFactor, v2 * yFactor, v3 *
   * zFactor)
   *
   * @param xFactor
   * @param yFactor
