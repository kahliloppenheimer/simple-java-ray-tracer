...
public abstract class Object3D implements Cloneable {
  ...
  public Optional<RayHit> findIntersection(Ray3D ray) {
    ...
    Ray3D inverseTransformed =
        new Ray3D(transformation.inverse().apply(ray.getStart()), inverseRayDirection);
  ...
  /** returns the intersection of the object with the passed Ray3D object, encoded as a RayHit */
